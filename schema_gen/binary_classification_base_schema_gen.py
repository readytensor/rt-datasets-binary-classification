...
def gen_binary_classification_base_schemas(schema_cfg, root_path):
    ...
    for dataset in datasets:
        ...
        schema_dict["inputDatasets"] = {
            "binaryClassificationBaseMainInput": {
                "idField": "",
                "targetField": "",
                "targetClass": model_category_config["datasets"][dataset][
                    "targetClass"
                ],
                "predictorFields": [],
            }
        ...
        input_dict = schema_dict["inputDatasets"]["binaryClassificationBaseMainInput"]
...
if __name__ == "__main__":
    ...
    gen_binary_classification_base_schemas(schema_cfg, root_path)
